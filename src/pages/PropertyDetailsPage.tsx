...
const PropertyDetailsPage: React.FC = () => {
  ...
  const translations = {
    ...
    es: {
      ...
      ownerInfo: 'Info del Propietario',
      notFound: 'Propiedad No Encontrada',
      notFoundDesc: 'La propiedad solicitada no se pudo encontrar',
      ...
      noAmenities: 'Sin comodidades especificadas',
    },
  };

  const txt = translations[language] || translations.ar;
